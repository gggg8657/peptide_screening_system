---
description: "PowerPoint 프레젠테이션 생성/편집/분석 스킬 — .pptx 파일 읽기, 템플릿 기반 편집, PptxGenJS로 처음부터 생성, 디자인 가이드라인 및 QA 프로세스 포함"
name: pptx
...
# Appendix: Editing Presentations (editing.md)
...
# Appendix: PptxGenJS Tutorial (pptxgenjs.md)
